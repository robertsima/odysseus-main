...
_register(
    {"delegate_to_agent", "manage_agent_loadout", "message_agent", "orchestrate_agents"},
    # Starting, configuring or messaging another agent chat (as send_to_session).
    ToolEffect.NETWORK_EGRESS,
    ToolEffect.WRITE_PRIVATE,
    result_integrity=ResultIntegrity.EXTERNAL_UNTRUSTED,
)
...
_register(
    {"manage_agent_worktree", "manage_git"},
    # Local history work plus fetch/push/publish to a remote.
    ToolEffect.WRITE_WORKSPACE,
    ToolEffect.NETWORK_EGRESS,
    ToolEffect.EXTERNAL_SIDE_EFFECT,
    result_integrity=ResultIntegrity.WORKSPACE_UNTRUSTED,
