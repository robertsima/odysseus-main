...
class _FakeDocsManager:
    ...
    def add_directory(self, directory, *, index=True, owner=None, sensitivity=None):
...
async def test_concurrent_add_directory_requests_serialize_indexing(tmp_path, monkeypatch):
    ...
    def _slow_index(self, directory, owner=None, sensitivity=None):
...
def test_failed_indexing_still_returns_500(tmp_path, monkeypatch):
    ...
    def _fail(directory, owner=None, sensitivity=None):
